	...
	document.cookie = "guest_id=" + "11947755583001" + ";path=/;domain=." + "53kf.com";

	var hz6d_cus_web_msg_gids = "";

	function hz6d_cus_web_msg_open(){
		var openurl = "https://www11.53kf.com/webCompany.php?kf_sign=Tk0MzMTY5Mc4NjExOTQ3NzU1NTgzMDAxNzI2Mzk1OTE=&arg=10639591&style=1&kflist=off&kf=1737380874%40qq.com&zdkf_type=1&lnk_overflow=0&language=cn&charset=GBK&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=https%3A%2F%2Fwww.sgpjbg.com%2Finfo%2F27629.html&keyword=https%3A%2F%2Fwww.google.com%2F&brief=&logo=&question=&uid=1085596760c5bcc59c6e846d4b3e2c06&guest_id=11947755583001&uuid_53kf=e2b7577c2be3b9471699ac8b4fd277e2&u_cust_id=&u_cust_name=&u_custom_info=";
		var itop = 200;
		var ileft = 200;
		try{
...
//	hz6d_get_guest_id_timer = setTimeout("hz6d_get_guest_id()", 500);
				...
				if (open_mini_windown == '1' && "jh3" == 'www111'){//品房阁需求 处理
					...
					if (last_invite_kf != '') {
						...
						try{
							...
							document.getElementById('iframe_company_mini').contentWindow.postMessage(lnk_msg,"https://www11.53kf.com/webCompany.php?kf_sign=Tk0MzMTY5Mc4NjExOTQ3NzU1NTgzMDAxNzI2Mzk1OTE=&arg=10639591&style=1&kflist=off&kf=1737380874%40qq.com&zdkf_type=1&lnk_overflow=0&language=cn&charset=GBK&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=https%3A%2F%2Fwww.sgpjbg.com%2Finfo%2F27629.html&keyword=https%3A%2F%2Fwww.google.com%2F&brief=&logo=&question=&uid=1085596760c5bcc59c6e846d4b3e2c06&guest_id=11947755583001&uuid_53kf=e2b7577c2be3b9471699ac8b4fd277e2&u_cust_id=&u_cust_name=&u_custom_info=");
						}catch(e){}
				}
					return;
				}
	...
	function hz6d_re_flashing(cid) {
		...
		var ivt_autotype			= "0";
		var zdyivt					= "0";
		var ivtstr					= "<div id=\"acc_title\" style=\"cursor:pointer;height:23px;width:100%;position:relative; line-height:23px\">  <div style=\"float:left;width:8px; background:url(https://www11.53kf.com/img/new06/fu-t-l.gif) no-repeat; height:23px;\"></div>  <div style=\"float:left;width:384px;height:23px; background:url(https://www11.53kf.com/img/new06/fu-t-c.gif) repeat-x ;line-height:23px;color:#ffffff;text-align:left;\">53KF&#36992;&#35831;</div>  <div style=\"float:left;width:8px; background:url(https://www11.53kf.com/img/new06/fu-t-r.gif) no-repeat; height:23px;\"></div></div><div style=\"clear:both;width:400px;background:url(https://www11.53kf.com/img/ivt/53kf01bg.gif);height:auto; overflow:hidden;\">  <div style=\"float:left;height:100%;width:100px;background: url(https://www11.53kf.com/img/ivt/53kf01bg.gif) left;   text-align:center;\"><img style=\"DISPLAY: inline;margin-top:10px;cursor:pointer;\" src=\"https://www11.53kf.com/img/kflogo/ivt_cn.gif\"/></div>  <div style=\"float:right;height:auto;*height:auto;*height:auto !important;width:300px;*width:298px;* width:295px !important; background:url(https://www11.53kf.com/img/ivt/53kf01bg.gif) right; text-align:left;\">    <div style=\"clear:both;width:95%;padding-top:10px; text-align:left;line-height:17px;font-family:tahoma;font-size:12px;color:#000000; height:auto; overflow:hidden;\">		&#27426;&#36814;&#24744;&#65281; <br /><span id=\"hz6d_acc_content\">acc_content</span></div>    <div style=\"clear:both;width:95%;margin-top:5px;text-align:right;\"><button id=\"hz6d_53kf_invite_acc\" onclick=\';onliner_zdfq=2;window.open(\"talk_openurl\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\");hidden_ivt();\' style=\"DISPLAY: inline; cursor:pointer;height:24px;width:76px;border:0px;background:none;\"><img style=\"DISPLAY: inline;\" src=\"https://www11.53kf.com/img/new06/fu-button1_cn.gif\" /></button>&nbsp;&nbsp;<button onclick=\';onliner_zdfq=3;hidden_ivt();\' style=\"DISPLAY: inline;cursor:pointer;height:24px;width:76px;border:0px;background:none;\"><img style=\"DISPLAY: inline;\" src=\"https://www11.53kf.com/img/new06/fu-button2_cn.gif\" id=\"hz6d_53kf_invite_hid\" /></button></div></div></div><div style=\"height:8px;width:100%;clear:both; line-height:8px; float:left;\">  <div style=\"height:8px;width:8px;float:left; background:url(https://www11.53kf.com/img/new06/fu-b-l.gif) no-repeat;line-height:8px;\"></div>    <div style=\"height:8px;width:384px;float:left; background:url(https://www11.53kf.com/img/new06/fu-b-c.gif) repeat-x;line-height:8px;\"></div>    <div style=\"height:8px;width:8px;float:right; background:url(https://www11.53kf.com/img/new06/fu-b-r.gif) no-repeat;line-height:8px;\"></div></div>";
		var is_autoyqk				= "0";
		...
		if ((pc_ivt_type == '2' || pc_ivt_type == '-1') && 0 == '0') {
			...
			Inv.prototype = {
				...
				talk : function(){
					...
					if (zdfq_type == 3) {
						...
						var openurl = "https://www11.53kf.com/webCompany.php?kf_sign=Tk0MzMTY5Mc4NjExOTQ3NzU1NTgzMDAxNzI2Mzk1OTE=&arg=10639591&style=1&kflist=off&kf=1737380874%40qq.com&zdkf_type=1&lnk_overflow=0&language=cn&charset=GBK&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=https%3A%2F%2Fwww.sgpjbg.com%2Finfo%2F27629.html&keyword=https%3A%2F%2Fwww.google.com%2F&brief=&logo=&question=&uid=1085596760c5bcc59c6e846d4b3e2c06&guest_id=11947755583001&uuid_53kf=e2b7577c2be3b9471699ac8b4fd277e2&u_cust_id=&u_cust_name=&u_custom_info=&tfrom=2" + force_kf;
						onliner_zdfq=2;
						var itop = 200;
						var ileft = 200;
						try{
			...
			tmp_innerHTML += '<div id="iframe_company_mini_div" style="'+mini_div_display+'font-size: 0;background-color:#fff;border-radius:2px;overflow:hidden;width:100%;height:'+mini_size_height+'px;box-shadow:0 5px 40px rgba(0,0,0,.16)!important;-webkit-box-shadow:0 5px 40px rgba(0,0,0,.16)!important;">'+
								'<h6 class="pc-visitor-header" style="width:100%;box-sizing:border-box;background: '+minicolor_tbbj+' no-repeat 10px;margin:0;padding:0;padding-left: 10px;font-size: 14px;color: #fff;height: 36px;line-height: 36px;position: relative;font-weight: normal;padding-right: 72px;">'+
									'<img style="max-width: 80px;width:auto;height:24px;float: left;margin-top: 6px;border-radius:2px;" src="https://filesys.53kf.com/storage/talk/72639591/11155751/TZnE56_1666143142_2022-10-19.jpg"/>'+
	...
	function show_floatWindow(type){//type:  zdfq:主动发起规则打开  qzzk:强制展开打开   不传:用户点击展开
		...
		try{
			...
			// if (navigator.userAgent.indexOf("Firefox") > -1){
				document.getElementById('iframe_company_mini').contentWindow.postMessage('openMini',"https://www11.53kf.com/webCompany.php?kf_sign=Tk0MzMTY5Mc4NjExOTQ3NzU1NTgzMDAxNzI2Mzk1OTE=&arg=10639591&style=1&kflist=off&kf=1737380874%40qq.com&zdkf_type=1&lnk_overflow=0&language=cn&charset=GBK&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=https%3A%2F%2Fwww.sgpjbg.com%2Finfo%2F27629.html&keyword=https%3A%2F%2Fwww.google.com%2F&brief=&logo=&question=&uid=1085596760c5bcc59c6e846d4b3e2c06&guest_id=11947755583001&uuid_53kf=e2b7577c2be3b9471699ac8b4fd277e2&u_cust_id=&u_cust_name=&u_custom_info=&tfrom=2");
			// }
	...
	{
		if(zdfq_switch == 'yes') {
			//document.cookie = "onliner_zdfq72639591="+onliner_zdfq;
			document.cookie = "my_acc_reauto_time=" + new Date().getTime() + ";path=/";
		} else {
			document.cookie = "my_acc_reauto_time=null;path=/";
		}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function close_company_mini(){
		...
		// if(acc_autotype == 3) {onliner_zdfq = 3;document.cookie = "onliner_zdfq72639591="+onliner_zdfq;}
			...
			if(vals[1])
			{
				...
				switch(valst[0])
				{
					case 'KF':
						...
						var click_open_url = 'window.open(\"https://www11.53kf.com/webCompany.php?kf_sign=Tk0MzMTY5Mc4NjExOTQ3NzU1NTgzMDAxNzI2Mzk1OTE=&arg=10639591&style=1&kflist=off&kf=1737380874%40qq.com&zdkf_type=1&lnk_overflow=0&language=cn&charset=GBK&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=https%3A%2F%2Fwww.sgpjbg.com%2Finfo%2F27629.html&keyword=https%3A%2F%2Fwww.google.com%2F&brief=&logo=&question=&uid=1085596760c5bcc59c6e846d4b3e2c06&guest_id=11947755583001&uuid_53kf=e2b7577c2be3b9471699ac8b4fd277e2&u_cust_id=&u_cust_name=&u_custom_info=&tfrom=2\",\"_blank\",\"height=600,width=800,top='+itop+',left='+ileft+',status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\")';
						...
						break;
						//click_str ='onliner_zdfq=2;get_open_start();window.open(\"https://www11.53kf.com/webCompany.php?kf_sign=Tk0MzMTY5Mc4NjExOTQ3NzU1NTgzMDAxNzI2Mzk1OTE=&arg=10639591&style=1&kflist=off&kf=1737380874%40qq.com&zdkf_type=1&lnk_overflow=0&language=cn&charset=GBK&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=https%3A%2F%2Fwww.sgpjbg.com%2Finfo%2F27629.html&keyword=https%3A%2F%2Fwww.google.com%2F&brief=&logo=&question=&uid=1085596760c5bcc59c6e846d4b3e2c06&guest_id=11947755583001&uuid_53kf=e2b7577c2be3b9471699ac8b4fd277e2&u_cust_id=&u_cust_name=&u_custom_info=&tfrom=2\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\");hidden_ivt();';break;
					case 'CLOSE':
						click_str = 'onliner_zdfq=3;jtfq_type=1;hidden_ivt();'; break;
					case 'ETEL':
						click_str = 'window.open(\'https://tb.53kf.com/eht.php?company_id=72639591&style_id=108535931\',\'_blank\',\'height=400,width=300,top=200,left=500,status=yes,toolbar=no,menubar=no,resizable=no,scrollbars=no,location=no,titlebar=no\')';break;
					case 'QQ':
						if(valst[1]){
